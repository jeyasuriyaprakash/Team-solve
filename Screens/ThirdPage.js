  ...
  return (
    <View style={styles.container}>
        ...
        <View style={{alignItems:'center',marginTop:50}}>
            ...
            <TouchableOpacity style={{flexDirection:'row'}}  onPress={()=>navigation.navigate('Page2')} >
            <Image source={require('../assets/leftarow.png')} />
           
            <Text style={{marginTop:0,color:'#134c3e',textAlign:'left'}}>Back</Text>
        
            </TouchableOpacity>
            </View>
            <View style={{justifyContent:'center',alignItems:'center'}}>
          
           <TouchableOpacity style={styles.textInput} onPress={()=>navigation.navigate('FourthPage')} >
            <Text style={styles.text}>IAM A CUSTOMER</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.textInput1} onPress={()=>navigation.navigate('FourthPage')}>
            ...
            <TouchableOpacity style={styles.continue} onPress={()=>navigation.navigate('FourthPage')}>
